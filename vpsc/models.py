...
# datamodel-codegen --input ./api-json.json --input-file-type openapi --output-model-type pydantic_v2.BaseModel --enum-field-as-literal all --reuse-model --strict-nullable --target-python-version 3.8 --output models.py
...
class ServerInterface(BaseModel):
    id: int = Field(..., description="id")
    device: str = Field(..., description="NIC名称", examples=["eth0"])
